...
class wxController
{
    ...
    {
        echo "Hello";
        //print_r(core::app()->params);  //获取配置
        //core::app()->logging("DEBUG", "loglog");
    }
    ...
    {
        core::app()->logging("DEBUG", "post you are at");
    ...
    public function his()
    {
        core::app()->logging("DEBUG", "his you are in");
    ...
    {
        core::app()->logging("DEBUG", "msgExt you are in");
    ...
    {
        core::app()->logging("DEBUG", "getting history messages list and putting them into wechat_tmplist");

        core::app()->logging("DEBUG", "history", $_POST);
